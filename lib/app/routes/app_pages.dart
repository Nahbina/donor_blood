...
import '../modules/AdminRatings/bindings/admin_ratings_binding.dart';
import '../modules/AdminRatings/views/admin_ratings_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.ADMIN_RATINGS,
      page: () => const AdminRatingsView(),
      binding: AdminRatingsBinding(),
    ),
  ];
}
